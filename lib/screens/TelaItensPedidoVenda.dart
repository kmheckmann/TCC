      ...
      body: FutureBuilder<QuerySnapshot>(
        //O sistema ira acessar o documento "pedidos" e depois a coleção de itens dos pedidos
          future: FirebaseFirestore.instance
              .collection("pedidos").doc(pedidoVenda.id).collection("itens").get(),
            ...
            if (!snapshot.hasData)
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    ...
                    ItemPedidoVenda itemPedido = ItemPedidoVenda.buscarFirebase(snapshot.data.docs[index]);
                    itemPedido.produto = _controller.produto;
                    return _construirListaPedidos(context, itemPedido, snapshot.data.docs[index], pedidoVenda);
                  });
          }),
    );
  }
